  ...
  return (
    <main className='space-y-2'>
      ...
      <Typography variant='body1'>
        Website ini diperuntukkan untuk membantu mahasiswa Informatika ITS dalam
        melakukan FRS. Berikut 3 hal yang bisa kamu lakukan di website ini:
      </Typography>
      ...
      <ul className='list-inside list-disc'>
        ...
        <li>Tidak dapat mengambil lebih dari 24 sks atau kurang dari 18 sks</li>
      </ul>
      <Typography variant='body1'>
      ...
      <Typography variant='body1'>
        Kalau ini kamu bisa pake buat nyari orang yang mau tukeran matkul. Kamu
        bisa lihat daftar postingan trade matkul di menu <b>Trading Matkul</b>.
        Untuk membuat postingan trade matkul, kamu bisa ikuti langkah-langkah
        berikut:
      </Typography>
      <ol className='list-inside list-decimal'>
        <li>
        ...
        <li>
          Pilih semester, nama mata kuliah, dan kode kelas dari kelas yang udah
          kamu ambil pas FRS
        </li>
        <li>
      ...
      <Typography variant='body1'>
        ...
        kamu. Kamu juga bisa mengubah atau menghapus postingan trade matkul yang
        sudah dibuat.
      </Typography>
      <div className='py-1' />
      <Typography variant='h3'>3. Informasi Jadwal</Typography>
      <Typography variant='body1'>
        Kamu juga bisa sekedar melihat jadwal setiap matkul dan kelas. Buka aja
        menu <b>Jadwal Matkul</b>. Kamu bisa lihat jadwal matkul menggunakan
        filter berdasarkan semester dan nama mata kuliah.
      </Typography>
    </main>
  );
}
