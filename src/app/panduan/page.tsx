  ...
  return (
    <main className="space-y-2">
      ...
      <Typography variant="body1">
        ...
        melakukan FRS yang terdiri dari 3 fitur sebagai berikut.
      </Typography>
      ...
      <Typography variant="body1">
        ...
        Kuota maksimal plan yang dapat dibuat adalah 3 untuk setiap akun. Setiap
        kali dilakukan pengambilan kelas, akan dilakukan validasi meliputi :
      </Typography>
      ...
      <Typography variant="body1">
        ...
        nama lengkap, id line, atau WA untuk memudahkan patner yang ingin trade
        dengan kamu. Kamu juga dapat mengubah atau menghapus postingan trade
        matkul yang telah dibuat.
      </Typography>
      <div className="py-1" />
      ...
      <Typography variant="body1">
        Terdapat beberapa batasan terkait informasi atau fitur yang ada sebagai
        berikut:{" "}
      </Typography>
      ...
      <Typography variant="body1">
        Dalam satu semester, satu akun hanya diperbolehkan untuk membuat hingga
        3 rencana FRS.
      </Typography>
      <Typography variant="h4">
